            ...
            <div>
              <div className="w-full pr-2">
                <ul className="flex space-x-2 lg:space-x-4 justify-center">
                  <li>
                    <Link href="https://www.facebook.com/kukudeals/" passHref={true}>
                      <svg
                        width="53"
                        height="52"
                  ...
                  <li>
                    <Link href="https://ae.linkedin.com/company/kukudeals" passHref={true}>
                      <svg
                        width="52"
                        height="52"
                        className="cursor-pointer fill-white hover:bg-[#ffd601] hover:fill-black rounded-full"
                  ...
                  <li>
                    <Link href="https://www.instagram.com/kukudeals/?hl=en" passHref={true}>
                      <svg
                        width="52"
                        height="52"
                        className="cursor-pointer fill-white hover:bg-[#ffd601] hover:fill-black rounded-full"
                  ...
                  <li>
                    <Link href="https://wa.me/971558610111" passHref={true}>
                      <svg
                        width="52"
                        height="52"
                        className="cursor-pointer fill-white hover:bg-[#ffd601] hover:fill-black rounded-full"
