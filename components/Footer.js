  ...
  return (
    <>
      <footer className="pb-2">
        <div className=" bg-white mx-auto py-2 pl-4 rounded-[15px]">
          <div className=" p-4 sm:flex lg:flex justify-between">
            <div className="flex tracking-tight	">
              <div className="pr-10 w-full">
                <div className="font-medium text-sm lg:text-lg text-gray-700 cursor-pointer hover:text-red-400">
                  Quick Links
                </div>
              ...
              <div className="w-full pb-4">
                <div className=" text-sm lg:text-lg text-gray-700 font-medium cursor-pointer hover:text-red-400">
                  Customer Service
                </div>
                <ul className="text-xs lg:text-base  pt-3 leading-loose  lg:leading-extra-loose	">
                  <li>
            ...
            <div className="">
              ...
              <div>
                <p className="flex justify-center text-center p-3 mt-2 text-sm">
      ...
      <footer className="py-2">
        <div className="pl-4 pr-5  bg-white mx-auto rounded-[15px] pb-2 ">
          <div className="sm:flex lg:flex   justify-between pt-6">
            <div className=" flex  space-x-1 items-center mb-2">
              <div className=" items-center w-16 h-7 relative cursor-pointer">
                <Image
              ...
              <div className="w-full flex space-x-1 lg:space-x-6 text-[9px] lg:text-xs">
                <p className="pr-[6px] pl-[6px]">© 2022. All rights reserved</p>
                <ul className="flex  lg:space-x-6 ">
                  <li className="pr-[6px] cursor-pointer hover:text-red-400">
                    <a>User Agreement</a>
                  </li>
