...
export default function Soldout1() {
  return (
    <div className="grid grid-cols-4 gap-2">
      ...
      <div className=" cursor-pointer absolute top-0 left-0 mt-12 ml-2 hover:shadow-outline w-52 h-44 cursor-pointer">
            <Image
          ...
          <div className="absolute top-3 left-5 mt-24 ml-4  w-36 h-24 object-cover">
            <Image
          ...
          <div className=" pt-56">
          <div className="text-center text-normal font-bold tracking-wide">
