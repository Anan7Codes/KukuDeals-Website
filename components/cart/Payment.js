                    ...
                    <div className="flex">
                        <div>
                            ...
                            <p className="text-white text-xs">
                                {t('spend')} <span className="font-bold">{t('aed')} 35</span> {t('deliver-para')}.<br/><span className="font-bold">{t('your-coupons')}</span> {t('will-be-used')}
                            </p>
                        </div>
                ...
                <>
                    <div className="bg-[#2c2c2c] item-centers justify-center rounded-2xl">
                        ...
                        <div className="flex items-center justify-center">
                            ...
                            />
                            <button onClick={promoLoading ? null : EnterPromoCode} className={`${i18n.language === 'ar' ? 'mr-3' : 'ml-3'} p-2 text-black w-[16%] h-11 rounded text-xs font-semibold bg-[#ffd601]`}>
