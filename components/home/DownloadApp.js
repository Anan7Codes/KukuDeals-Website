...
export default function DownloadApp() {
    return (
      <div className="flex flex-col lg:flex-row items-center justify-between py-6 px-8 my-3 bg-[#2c2c2c] mx-auto w-full rounded-[10px]">
          <div>
            <p className="text-2xl lg:text-3xl font-title font-semibold text-[#ffd601]">Download our app and never miss a draw!</p> 
            <p className="text-sm lg:text-xl font-semibold text-white">Available on App Store and Google Play Store</p>
          </div>
