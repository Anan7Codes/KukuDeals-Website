        ...
        <div className="flex-col w-full pb-6 lg:pb-0">        
          ...
          <div className="absolute -top-4 -right-4 h-20 w-28 lg:h-28 lg:w-32 p-2 bg-white rounded-full">
            ...
            <div className="flex flex-col text-center absolute top-0 h-20 w-20 mt-7 ml-2 lg:ml-4">
              <p className="text-lg lg:text-2xl font-semibold text-gray-600 leading-4 lg:leading-none">{campaign?.SoldOutCoupons}</p>
              ...
              <p className="text-md lg:text-xl font-normal text-gray-300 leading-4 lg:leading-none">{campaign?.TotalCoupons}</p>
            </div>
          </div>
        </div>
      </div>
