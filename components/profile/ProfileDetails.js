...
export default function ProfileDetails() {
  ...
  useEffect(() => {
    const InsertProfileData = async () => {
      try {
        ...
        mutation insertProfile($id:uuid!,$countryOfResidence:String!) {  
          insert_Profiles(objects: {amountSpent: 25, countryOfResidence: "uae", gender: false, nationality: "srilanka", phoneNumber: "1234", shippingAddress: {"street":"damam"}}) {
            id
          }
  ...
  //   insertProfile(object: {amountSpent: 25, countryOfResidence: "uae", gender: false, nationality: "srilanka", phoneNumber: "1234", shippingAddress: "{\"street\":\"damam\"}"}}) {
  //     id
  //   }
  // }`;
