...
<body>
    <div class="flex min-h-screen bg-gray-100">
        <div class="w-3/5 bg-white shadow-lg">
            <div class="flex justify-between m-6">
            <img class="items-center justify-center w-32 h-14" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRZ9hpbDkb5HdKE1RLtaMig_Gs24n8VsRIJ7KStu3T_1mX4kDaM23z2RXm8Z5Gd31QftaM&usqp=CAU" alt="HTML tutorial" style="width:200px;height:200px;border:0">
                <img src="https://i.postimg.cc/j2znKT6V/kukudealslogo-black.png"
                    class="flex items-center w-12 h-8 relative cursor-pointer" layout="fill" alt="kuku logo" />
                <div class="">
                    <ul class="flex">
                        <li class="flex flex-col ">
                            <span class="text-sm font-bold">
