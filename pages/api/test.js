...
<div class="w-full bg-red-600 shadow-lg">
 <div class="flex justify-between m-6 w-32">
     <img style="" src="https://i.postimg.cc/j2znKT6V/kukudealslogo-black.png"
 ...
 <div class="flex text-xs m-6 justify-between p-4">
     ...
     <div class="">
         <div>
             <h6 class="font-bold">Invoice No : <span class=" font-medium">KUKU00001</span></h6>
...
500
 ...
 <div class = "border border-black text-center py-4">Coupon No: kuku-0001</div>
</div>`
        )
    })
    ...
    pdfDoc.on('end', async function () {
        ...
        const data1 = {
            ...
            personalizations: [
                {
                    to: ['mohammedhafizba@gmail.com', 'hafizba956@gmail.com'],
                    subject: 'Order Confirmation',

                },
            ],
            content: [{ type: "text/html", value: head + body1 + footer + body2 },],
            attachments: [
                {
