...
const webhookHandler = async (req, res) => {
    let initiated_orders = await supabase
        ...
        .select('*')
        .eq("verification_secret", 'pi_3Kg2TuLSsCUq84XE1V8QIS7d')
                ...
                <td align="left" bgcolor="#161616" style="color:white;padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                    ...
                    <tr>
                        <td colspan="2" style="line-height: 32px;font-size:16px;padding:5px 15px 0 12px;">
                            ...
                            <b>Transaction Number:</b> 439723497<br>
                            <b>Purachse Date:</b> 23/03/2022
                         </td>                
                        </tr>
                        <tr>
                            ...
                            <td align="right" width="90%" style="padding: 10px 0px 0px 0px;min-width:150px;font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 16px;">AED190.00</td>
                          </tr>
                        <tr>
                            ...
                            <td align="right" width="90%" style="padding: 10px 0px 10px 0px;min-width:150px;font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 16px;">AED90.00</td>
                          </tr>
                        <tr>
                            ...
                            <td align="right" width="90%" style="padding: 10px 0px 10px 0px;min-width:150px;border-top: 2px dashed #D2C7BA; border-bottom: 2px dashed #D2C7BA;font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 24px; line-height: 24px;"><b>AED190.00</b></td>
                          </tr>
                        <tr>
                  ...
                  <table  border="0" cellpadding="0" cellspacing="0" width="100%">
                    ...
                    <tr>
                        <td colspan="2"bgcolor="#2c2c2c" style="color:white;line-height: 2px;font-size:16px;padding:5px 15px 0 12px;">
                          ...
                          layout="fill" alt="kuku logo" />
                          <p><b>Product: </b><span>Zorro Pencil</span></p><br>
                          ...
                          <p align="right" bgcolor="#161616" width="75%" style="font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 2px;">Coupon No.<strong>EL-00823-00611-O</strong></p>
                          <p align="right" bgcolor="#161616" width="75%" style="font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 2px;">Coupon No.<strong>EL-00823-00611-O</strong></p>
                         </td>       
                         <td>
                         </td>      
...
for (var i = 0; i < rows.length; i++) {
    ...
    console.log("cjeck", rows[i].product_price)
    row.push({text:rows[i].name,style:'tableValue'});
    row.push({text:rows[i].product_qty,style:'tableValue'});
    row.push({text:`AED${rows[i].product_price}`,style:'tableValue'});
    row.push({text:`AED${rows[i].product_price* rows[i].product_qty * 0.95}`,style:'tableValue'});
    row.push({text:"5%",style:'tableValue'});
    row.push({text:`AED${rows[i].product_price* rows[i].product_qty * 0.05}`,style:'tableValue'});
    row.push({text:`AED${rows[i].product_price* rows[i].product_qty }`,style:'finalAmount'});
    body.push(row);
}
const document = {
...
header: {
    ...
    content: [
        ...
        },
        {
            columns: [
                ...
                {
                    text: 'mohammedhafizba@gmail.com',
                    style: 'invoiceSubValue',
                    alignment: 'left',
                    margin: [-101, -90, 0, 0]
                },
    ...
    pdfDoc.on('end', async function () {
            ...
            personalizations: [
                {
                    ...
                    // 'anan07dhu@outlook.com', 'kukudealsdev@gmail.com'
                ],
        ...
        try {
            ...
            console.log(resp)
            return res.status(200).json({ status: 'Email sending success' });
