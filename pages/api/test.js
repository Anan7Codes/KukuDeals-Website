...
content: [
    '\n\n\n\n',
    {
        columns: [
            ...
            {
                text: `${String(1 + 1).padStart(4, '0')}-${moment(new Date().toLocaleString()).format('YYYYMMDD')}`,
                style: 'invoiceSubValue',
                alignment: 'right',
                margin: [-0, -110, 110, 0]
            },
...
pdfDoc.on('end', async function () {
    ...
    const data1 = {
        ...
        personalizations: [
            {
                to: [`anan07dhu@outlook.com`, 'kukudealsdev@gmail.com'],
                subject: 'Order Confirmation',
                dynamicTemplateData: {
                    transactionNumber: `${String(1 + 1).padStart(4, '0')} - ${moment(new Date().toLocaleString()).format('YYYYMMDD')}`,
                    purchaseDate: `${moment(new Date().toLocaleString()).format('ll')}`,
                    totalBeforeVat: `AED ${(120 * 0.95).toFixed(2).toString()}`,
                    vatAmount: `AED ${(120 * 0.05).toFixed(2).toString()}`,
                    total: `AED ${(120).toString()}`,
                    coupons: coupons,
                }
            },
        ],
        attachments: [
            {
                ...
                filename: `KUKU${String(1 + 1).padStart(5, '0')}-${moment(new Date().toLocaleString()).format('YYYYMMDD')}.pdf`,
