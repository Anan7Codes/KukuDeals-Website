                ...
                <div className="w-full">
                    <div className="flex flex-col items-center rounded-[15px] bg-[#2c2c2c] px-16 py-12">
                        ...
                        <div className="flex justify-between">
                            <button onClick={enterCode ? SubmitCode : GetCode} className="bg-[#ffd601] mt-4 lg:w-[380px] w-[300px] outline-none rounded-[5px] h-12 text-black font-semibold text-base">
