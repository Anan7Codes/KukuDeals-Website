    ...
    return (
        ...
        <Layout>
            <div className="text-white">
                ...
                <p className="text-3xl text-[#ffd601] pt-5 font-bold pb-5 font-title" >1. Your information</p>
                <li className="text-base pb-4  leading-loose text-justify">The type of information we collect from you is either personal to you, or is general in nature</li>
                <li className="text-base pb-4 leading-loose	text-justify">Personal Information: When you register on the platform as a member, update your information, purchase any goods or services, take part in promotions or send emails to us, you provide us with information that we store and process. Such information may include your name, address, phone number, email address, purchase and transaction history, interests, and other such &aposPersonal Information&apos.</li>
                <li className="text-base pb-4 leading-loose text-justify">General Information: We also receive more general information from you as a result of your visits to, and use of, the platform. This general information does not identify you personally, and can include information such as your IP address, the date and time you access the platform, length of time you spend on the platform, your browsing history (recorded by the text and graphics files that compose that page), the Internet address of the website from which you linked directly to our platform, and other such &aposGeneral Information&apos.</li>
